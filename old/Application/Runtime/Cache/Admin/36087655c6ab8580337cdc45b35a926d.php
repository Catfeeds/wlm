    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-title">
            	<form name="search" action="<?php echo U('News/search');?>" method="post">
                <div class="result-list">  
                	<a href="<?php echo U('News/add');?>"><i class="icon-font"></i>添加资讯</a>                  
                    <a id="updateOrd" href="<?php echo U('News/index');?>"><i class="icon-font"></i>刷新页面</a>
                </div>
                </form>
            </div>
            <div class="result-content">
                <table class="result-tab" width="100%">
                    ...
                    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                        ...
                        <td><?php echo (getCompany($vo["company_id"])); ?></td>
                        <!-- <td><?php echo (getDomainName($vo["domain_id"])); ?></td> -->                        
                        <!-- <td><?php echo (getNewsType($vo["news_type_id"])); ?></td> -->
                        <td><?php echo (date('Y-m-d H:i:s',$vo["addtime"])); ?></td>
                        <td><?php echo (is_show($vo["isshow"])); ?></td>
                        <td><?php echo ($vo["num_true"]); ?></td>
                        <td><?php echo ($vo["num_edit"]); ?></td>
                        <td>	 
                        	<a class="link-update" href="<?php echo U('News/edit',array('id'=>$vo[id]));?>">修改</a>                              
                           	<a class="link-update" href="<?php echo U('News/lock',array('id'=>$vo[id],'isshow'=>$vo[isshow]));?>"><?php echo (nav_action($vo["isshow"])); ?></a>
                           	<a class="link-update del" href="<?php echo U('News/del',array('id'=>$vo[id]));?>">删除</a>
                        </td>
