						...
						<div class="tabbable" style="margin-top:30px">
							<div class="tab-content">
								<div class="tab-pane active">
									<form action="<?php echo U('Nav/insert');?>" method="post" enctype="multipart/form-data" id="edit-profile" class="form-horizontal">
										<fieldset>
											...
											<div class="control-group">
												...
												<div class="controls">
													<input id="title" style="width:300px" class="input-medium" type="text" value="" name="time">
