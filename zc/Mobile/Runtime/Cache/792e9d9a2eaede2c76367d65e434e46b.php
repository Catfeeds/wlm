...
<div class="toper fixed">
	...
	<div class="login1" >
		<div class="login2">
			<?php if($_SESSION['uid'] != null): ?><a href="<?php echo U('User/login');?>"><div class="login"><span class="icon-user login_icon" style="margin-right:10px"></span><?php echo ($_SESSION['uname']); ?></div></a>
			<?php else: ?>
...
<div class="main">
	<div class="container">
		<h3 class="news_mtop news_title"><?php echo ($news["title"]); ?></h3>
		<p class="border-top-bottom border-dashed padding-small">
			<span>作者：<?php echo ($news["author"]); ?></span><span>关键字：<?php echo ($news["content"]); ?></span>
		</p>
		<div class="detail">
