		...
		<div class="row">
			...
			<div class="span9">
							...
							<tbody>
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr style="height:100px">
										...
										<td class="action-td">
											...
											<a href="<?php echo U('Img/delFlash',array('id'=>$vo['id']));?>" class="btn btn-small">
				...
				<div style="display:none">
					<form id="flash_img" action="<?php echo U('Img/uploadImg');?>"  method="post"  target="hidden_frame" enctype="multipart/form-data">
