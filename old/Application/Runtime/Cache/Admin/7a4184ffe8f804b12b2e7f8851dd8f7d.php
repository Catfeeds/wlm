        ...
        <div class="result-wrap">
            <div class="result-title">
                <div class="result-list">               
                    <a id="updateOrd" href="<?php echo U('Article/index');?>"><i class="icon-font"></i>刷新页面</a>
            </div>
                ...
                <table class="result-tab" width="100%">
                    ...
                    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                        ...
                        <td>
                        	...
                        	<?php if(!empty($vo['child'])): if(is_array($vo['child'])): foreach($vo['child'] as $key=>$v): ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($v['title']); ?><br /><?php endforeach; endif; endif; ?>
                        </td>                        
                        <td>
                        	<?php echo (is_show($vo["isshow"])); ?><br />
                        	<?php if(!empty($vo['child'])): if(is_array($vo['child'])): foreach($vo['child'] as $key=>$v): ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo (is_show($v["isshow"])); ?><br /><?php endforeach; endif; endif; ?>
                        </td>
                        <td width="20%">	
                        	<a class="link-update" href="<?php echo U('Article/edit',array('id'=>$vo[id]));?>">编辑</a>                               
                           	<a class="link-update" href="<?php echo U('Article/lock',array('id'=>$vo[id],'isshow'=>$vo[isshow]));?>"><?php echo (nav_action($vo["isshow"])); ?></a>
                           	<a class="link-update del" href="<?php echo U('Article/del',array('id'=>$vo[id]));?>">删除</a>
                           	<br />
                           	<?php if(!empty($vo['child'])): if(is_array($vo['child'])): foreach($vo['child'] as $key=>$v): ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        			<a class="link-update" href="<?php echo U('Article/edit',array('id'=>$v[id]));?>">编辑</a>                               
		                           	<a class="link-update" href="<?php echo U('Article/lock',array('id'=>$v[id],'isshow'=>$v[isshow]));?>"><?php echo (nav_action($v["isshow"])); ?></a>
		                           	<a class="link-update del" href="<?php echo U('Article/del',array('id'=>$v[id]));?>">删除</a>
		                           	<br /><?php endforeach; endif; endif; ?>
                        </td>
