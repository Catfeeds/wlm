...
<style>
.ulclass li{height:auto;list-style:none;}
...
.btn2 { margin:0 20px 0 0; border-radius: 4px;  font-size: 9pt;    color: #003399;    border: 1px #003399 solid;    color: #006699;    border-bottom: #93bee2 1px solid;    border-left: #93bee2 1px solid;    border-right: #93bee2 1px solid;    border-top: #93bee2 1px solid;    background-image: url(../images/bluebuttonbg.gif);    background-color: #ff99ff;    cursor: hand;    font-style: normal;    width: 60px;    height: 22px;}
</style>
</head>
...
<div class="container hot">
	<ul class="ulclass">
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
				<div style="float:left;width:30%;padding:10px 0 20px 20px;">
					<img style="width:100px" src="<?php echo ($vo["image"]); ?>"/>
				</div>
				<div style="float:left;width:70%;padding:10px 0 20px 20px;">
					<div style="font-size:16px;"><?php echo ($vo["name"]); ?></div>
					<div><?php echo ($vo["bri"]); ?></div>
					<div>
					<a class="button bg-main" href="<?php echo U('Trade/gozr',array('now_id'=>$vo['id']));?>">转让</a>
					<a class="button bg-main" href="<?php echo U('Trade/gozr',array('now_id'=>$vo['id']));?>">减持</a>
				</div>
				</div>
