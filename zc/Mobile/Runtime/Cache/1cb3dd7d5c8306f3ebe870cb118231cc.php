...
<div class="container hot">
	<div class="">
		<?php if(is_array($pro)): $i = 0; $__LIST__ = $pro;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="media" >
					<div class="detail">
					...
					<div class="media-body">
						...
						<div class="line" style="margin-top:15px; ">
							<div class="x4 border-right" style="padding-left:20px;">
