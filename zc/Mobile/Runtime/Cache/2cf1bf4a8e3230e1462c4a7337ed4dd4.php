...
<body onload="go()"> 
	...
	<div class="center2">
		...
		<div style="text-align:center;">
			<div><font class="fontclass">恭喜您注册成功！点击<a href=""><font class="fontclass2">个人中心</font></a>可进入操作界面</font></div>
			<div><font class="fontclass">将在 <span id="mes">5</span> 秒钟后返回首页！</font> </div>
			<div style="margin-top:40%;"><font class="fontclass">若此页面未能跳转，请点此<a href="<?php echo U('Index/index');?>"><font class="fontclass2">个人中心</font></a></font></div>
