...
<div class="main">
	<div class="container">
		<h3 class="news_mtop">最新公告</h3>
		<hr class="top_hr"/>
		<ul class="list-text list-unstyle">
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><img src="<?php echo ($vo["image"]); ?>" alt="" style="width:50px; height:50px" /><a href="<?php echo U('News/html',array('id'=>$vo['id']));?>"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
		</ul>
	</div>
</div>
</body>
