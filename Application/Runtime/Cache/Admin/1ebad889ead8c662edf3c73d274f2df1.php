		...
		<div class="row">
			...
			<div class="span9">
				...
				<div class="widget widget-table">
					...
					<a href="<?php echo U('News/add');?>" class="btn btn-small btn-warning" style="margin-top:10px;margin-bottom:10px;">
						添加新闻							
					</a>
						...
						<table class="table table-striped table-bordered">
							...
							<tbody>
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr style="height:100px">
										...
										<td>
											<a href="<?php echo U('News/save',array('id'=>$vo['id']));?>"><?php echo ($vo["title"]); ?></a>
										</td>
										<td>
										...
										<td class="action-td">
											...
											<a href="<?php echo U('News/del',array('id'=>$vo['id']));?>" class="btn btn-small">
