...
<div class="container hot">
	<div class="">
		<?php if(is_array($clist)): $i = 0; $__LIST__ = $clist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="media" >
					<div class="detail">
						<p align="center"><a href="<?php echo U('Deal/show',array('id'=>$vo['id']));?>"><img src="<?php echo ($vo["image"]); ?>" style="width:100%" class="img-responsive"/></a></p>
					...
					<div class="media-body">
						...
						<div class="progress progress-small inv_progress">
  							<div class="progress-bar bg-blue" style="width:<?php echo ($vo["jindu"]); ?>;"></div>
						</div>
						<!-- <p class="center"><?php echo ($vo["user_name"]); ?>(<?php echo ($vo["province"]); ?>,<?php echo ($vo["city"]); ?>)</p> -->
						<div class="line" style="margin-top:15px; ">
							<div class="x4 border-right" style="padding-left:40px;">
								<p><strong><?php echo ($vo["jindu"]); ?></strong></p>
								<p>已达</p>
							</div>
							<div class="x4 border-right" style="padding-left:40px;">
								<p><strong><?php echo ($vo["support_amount"]); ?></strong></p>
								<p>已筹</p>
							</div>
							<div class="x4 border-right" style="padding-left:40px;">
								<p><strong><?php echo ($vo["time"]); ?></strong></p>
								<p>剩余时间</p>
							</div>
						</div>
					</div>
